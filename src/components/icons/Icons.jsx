...
export function Brain({ className = '' }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function Flag({ className = '', filled = false }) {
  return (
...
export function Sparkles({ className = '' }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 3c.132 0 .263 0 .393 0A8 8 0 0 0 21 11.607a.5.5 0 0 1 0 .786A8 8 0 0 0 12.393 21a.5.5 0 0 1-.786 0A8 8 0 0 0 3 12.393a.5.5 0 0 1 0-.786A8 8 0 0 0 11.607 3c.13 0 .261 0 .393 0z" />
    </svg>
  )
}
